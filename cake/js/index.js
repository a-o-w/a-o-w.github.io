$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Давайте сделаем торт!','Поскольку это ваш День Рождения, Я нахожу его подходящим только для того, чтобы Вы сделали свой собственный цифровой торт. Начните с приготовления смеси, затем выпекайте ее в цифровой духовке и, наконец, украсьте. Веселитесь и с Днем Рождения');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 6){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Замешивание успешно завершено!','Поздравляем, смесь замечательная! После заливки смеси в форму для выпечки, настало время положить ее в нашу цифровую духовку примерно на 3 секунды. Этого времени должно быть достаточно  для хорошей основы.');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Выпечка успешна!',' ДА ! Вы мастер шеф. Основа полость пропеклась и выглядит очень аппетитно. Пришло время комбинировать эту бисквитную основу с другими ингредиентами, такими как джем, шоколад и другими.');
    }
})
